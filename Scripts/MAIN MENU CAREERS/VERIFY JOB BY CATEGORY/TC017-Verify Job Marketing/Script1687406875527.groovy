...
WebUI.click(findTestObject('MENU CAREERS/p_Business Development'), FailureHandling.STOP_ON_FAILURE)

WebUI.scrollToElement(findTestObject('MENU CAREERS/h6_Job Search'), 0)

WebUI.verifyTextPresent('2 available positions in 1 countries', true)
