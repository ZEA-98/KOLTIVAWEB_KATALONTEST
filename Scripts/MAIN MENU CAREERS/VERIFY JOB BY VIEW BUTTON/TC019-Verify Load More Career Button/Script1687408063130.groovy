...
WebUI.click(findTestObject('MENU CAREERS/a_VIEW Jobs'), FailureHandling.STOP_ON_FAILURE)

WebUI.scrollToElement(findTestObject('MENU CAREERS/h6_Job Search'), 0)

WebUI.scrollToPosition(50, 60)

WebUI.click(findTestObject('MENU CAREERS/button_Load More Careers'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyTextPresent('10 available positions in 2 countries', false)
